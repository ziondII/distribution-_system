...
<div class="container">
    ...
    <!-- Existing form fields for updating student details -->
    <div class="mb-3">
    ...
    <div class="mb-3">
        <label for="image" class="form-label">Schedule</label>
...
<div>
<form action="<?= ROOT ?>/admin/deletestudent/<?= $student->id ?>" method="POST" style="display:inline;">
